-- Part 5: Daily Nutrition - 30 days

INSERT INTO daily_nutrition (
  athlete_id, date, calories_total, calories_target, protein_g, protein_target_g,
  carbs_g, carbs_target_g, fat_g, fat_target_g, fiber_g, sodium_mg, potassium_mg,
  magnesium_mg, water_liters, total_fluids_liters, meals_count, snacks_count,
  vegetables_servings, fruits_servings, nutrition_score, pre_workout_carbs_g,
  during_workout_carbs_g, during_workout_fluids_ml, post_workout_protein_g,
...
('00000000-0000-0000-0000-000000000001', CURRENT_DATE - 28, 2200, 2400, 140, 145, 260, 280, 75, 80, 28, 1800, 2800, 350, 2.5, 3.0, 3, 1, 3, 2, 80, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'myfitnesspal'),
...
('00000000-0000-0000-0000-000000000001', CURRENT_DATE - 24, 2300, 2500, 145, 150, 275, 300, 78, 82, 30, 1900, 2900, 360, 2.8, 3.4, 3, 2, 4, 2, 78, NULL, NULL, NULL, NULL, NULL, NULL, 100, 'myfitnesspal'),
...
('00000000-0000-0000-0000-000000000001', CURRENT_DATE - 21, 2800, 2400, 135, 145, 380, 280, 92, 80, 25, 2500, 2600, 320, 2.2, 3.5, 4, 3, 2, 1, 65, NULL, NULL, NULL, NULL, NULL, NULL, 80, 'myfitnesspal'),
...
('00000000-0000-0000-0000-000000000001', CURRENT_DATE - 17, 2420, 2550, 146, 150, 298, 315, 78, 83, 31, 2000, 3100, 370, 2.8, 3.4, 3, 2, 4, 2, 72, 30, NULL, NULL, 32, 50, 75, 160, 'myfitnesspal'),
...
('00000000-0000-0000-0000-000000000001', CURRENT_DATE - 13, 2280, 2450, 142, 148, 275, 295, 76, 81, 29, 1880, 2880, 355, 2.6, 3.2, 3, 2, 4, 2, 72, NULL, NULL, NULL, NULL, NULL, NULL, 120, 'myfitnesspal'),
...
('00000000-0000-0000-0000-000000000001', CURRENT_DATE - 10, 2350, 2500, 143, 148, 285, 300, 77, 82, 30, 1950, 2980, 362, 2.6, 3.2, 3, 2, 4, 2, 72, 28, NULL, NULL, 30, 45, 74, 155, 'myfitnesspal'),
...
('00000000-0000-0000-0000-000000000001', CURRENT_DATE - 7, 2350, 2500, 145, 150, 285, 300, 78, 82, 30, 1920, 2920, 358, 2.7, 3.3, 3, 2, 4, 2, 80, NULL, NULL, NULL, NULL, NULL, NULL, 100, 'myfitnesspal'),
...
('00000000-0000-0000-0000-000000000001', CURRENT_DATE - 3, 2380, 2520, 144, 150, 288, 305, 77, 82, 30, 1960, 3000, 362, 2.6, 3.2, 3, 2, 4, 2, 70, 28, NULL, NULL, 30, 45, 72, 155, 'myfitnesspal'),
